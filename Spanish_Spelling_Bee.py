...
def get_translations():
    translations = []
    with open('Spanish_Words', 'r', encoding='utf-8') as spanishFile:
        for spanishWord in spanishFile:
            spanishWord = spanishWord.replace('\n', '')
            translations.append([spanishWord])
    with open('English_Translations', 'r', encoding='utf-8') as englishFile:
        i = 0
...
# IMAGES
BG = pygame.image.load("assets/gradient.png").convert_alpha()
